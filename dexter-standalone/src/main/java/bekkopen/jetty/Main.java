...
public class Main {
	...
	public Main() {
		...
		contextPath = System.getProperty("jetty.contextPath", "/dexter-webapp");
		workPath = System.getProperty("jetty.workDir", null);
		secret = System.getProperty("jetty.secret",
				"eb27fb2e61ed603363461b3b4e37e0a0");
	}
	...
	private void usage() {
		System.out
				.println("Usage: java -jar <file.jar> [start|stop|status|enable|disable]\n\t"
