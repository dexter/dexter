...
/**
 * Enrich a file containing a list of labels adding the document frequency of a
 ...
 */
public class GenerateSpotDocumentFrequencyCLI extends AbstractCommandLineInterface {
	/**
