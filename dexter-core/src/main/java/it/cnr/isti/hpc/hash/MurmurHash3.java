...
public class MurmurHash3 implements Hash {
	...
	public long hashLong(long[] payload) {
		return MurmurHash3_x64_64(payload, 9001);
	}
	...
	public long hashLong(long hashcode) {
		...
		b[2] = (byte) (hashcode >>> 16);
		b[3] = (byte) (hashcode >>> 24);
		b[4] = (byte) (hashcode >>> 32);
		b[5] = (byte) (hashcode >>> 40);
		b[6] = (byte) (hashcode >>> 48);
		b[7] = (byte) (hashcode >>> 56);
		return hash(b);
	}
	...
	public long hashLong(Object o) {
		if (o instanceof byte[])
			return hashLong((byte[]) o);
		else if (o instanceof long[])
			return hashLong((long[]) o);
		else if (o instanceof String)
			return hashLong(((String) o).getBytes(UTF8));
		else
			return hashLong(o.hashCode());
	}
