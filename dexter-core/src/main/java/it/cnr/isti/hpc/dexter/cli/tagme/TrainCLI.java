...
public class TrainCLI extends AbstractCommandLineInterface {
	...
	public static void main(String[] args) {
		...
		double epsilon = disambiguator.train(training);
		logger.info("best epsilon = {}",epsilon);
