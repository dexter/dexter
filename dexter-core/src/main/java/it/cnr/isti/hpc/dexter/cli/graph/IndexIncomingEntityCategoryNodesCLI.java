...
/**
 * IndexIncomingEntityCategoryNodesCLI generate the binary file containing the
 * incoming entities for a category. Takes a file containing the incoming
 * categories in the format: <br>
 * <br>
 * <code>
 * category_id <tab> e1 e2 ... eN  
 * 
 * </code> <br>
 * <br>
 * where <code> e1 e2 .. eN </code> are the enitty linking to the given
 * category, The file is sorted by <code>category_id</code>, and in each line
 * the incoming entities are sorted by their numerical id.
 * 
 * @author Diego Ceccarelli, diego.ceccarelli@isti.cnr.it created on 21/nov/2011
 */
public class IndexIncomingEntityCategoryNodesCLI extends
		AbstractCommandLineInterface {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = LoggerFactory
			.getLogger(IndexIncomingEntityCategoryNodesCLI.class);
	...
	public static void main(String[] args) {
		...
		NodesWriter writer = EntityCategoryNodeFactory
				.getIncomingNodeWriter(EntityCategoryNodeFactory.STD_TYPE);
		for (Node n : reader) {
			pl.up();
			writer.add(n);
		}
	...
	public IndexIncomingEntityCategoryNodesCLI(String[] args) {
