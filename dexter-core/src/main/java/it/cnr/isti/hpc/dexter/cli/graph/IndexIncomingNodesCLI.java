 ...
 * entities. Takes a file containing the incoming entities in the format: <br>
 * <br>
 * <code>
 ...
 * <code> entity_id </code>. The file is sorted by <code>entity_id</code>, and
 * in each line the incoming entities are sorted by their numerical id.
 * 
...
public class IndexIncomingNodesCLI extends AbstractCommandLineInterface {
	...
	public static void main(String[] args) {
		...
		File incomingFile = dexterParams
				.getGraph("entity-entity", Direction.IN);
		...
		NodesWriter writer = NodeFactory
				.getIncomingNodeWriter(NodeFactory.STD_TYPE);
		for (Node n : reader) {
			pl.up();
			writer.add(n);
		}
